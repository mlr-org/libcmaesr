...
namespace libcmaes
{
  ...
  class Parameters
    ...
    protected:
      ...
      uint64_t _xmean_rng_draws = 0; /**< libcmaesr patch: counts random initial-mean draws so every CMASolutions construction (e.g. IPOP/BIPOP restarts) samples a fresh, seed-reproducible mean. */
