...
vector and returns a single number.
[`cmaes_control()`](https://libcmaesr.mlr-org.com/dev/reference/cmaes_control.md)
collects the settings of the algorithm, and
[`cmaes()`](https://libcmaesr.mlr-org.com/dev/reference/cmaes.md) runs
the optimization.
...
The variant is selected with the `algo` argument of
[`cmaes_control()`](https://libcmaesr.mlr-org.com/dev/reference/cmaes_control.md).
